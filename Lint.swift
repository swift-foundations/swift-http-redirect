...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-http-redirect open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-http-redirect project authors
